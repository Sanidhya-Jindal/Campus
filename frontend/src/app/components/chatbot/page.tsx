...
import { AGENT_BASE } from "../../lib/api";
        ...
        <>
            ...
            {!isOpen && (
                <button
                    ...
                    className="fixed bg-gradient-to-br from-slate-800 via-slate-900 to-black text-white rounded-2xl p-4 shadow-2xl hover:shadow-green-500/50 transition-all duration-300 hover:scale-110 border-2 border-green-500/50 group cursor-move z-[1200]"
                    style={{
