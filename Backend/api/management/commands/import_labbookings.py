...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Parse timestamps. This CSV mixes two formats ("9/5/2025 16:46" and
        # "2025-08-27 00:01:00"); pandas>=2 infers one format from the first
        # row and coerces the rest to NaT, silently dropping ~88% of rows.
